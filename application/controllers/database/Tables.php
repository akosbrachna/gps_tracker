...
class Tables extends Base_Controller
{
    ...
    private function user()
    {
        ...
        $this->dbforge->add_field("reset_password varchar(255) DEFAULT NULL");
        $this->dbforge->add_field("new_email varchar(255) DEFAULT NULL");
        $this->dbforge->add_field("change_email varchar(255) DEFAULT NULL");
